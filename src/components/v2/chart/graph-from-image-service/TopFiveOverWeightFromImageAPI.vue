<template>
  <va-card>
    <va-card-title>
      <p class="text-xl">จำนวนที่ผ่านระบบที่มีน้ำหนักคาดว่าจะเกินตามลำดับจาก มากไปน้อย (5อันดับแรก)</p>
    </va-card-title>
    <va-card-content>
...
<script setup lang="ts">
  ...
  const horizontalBarChartDataGenerated = useChartData(dashboardStore.top5OverWeightDashboard)
</script>
