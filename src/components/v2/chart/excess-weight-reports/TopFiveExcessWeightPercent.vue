<template>
  <va-card>
    <va-card-title
      >ข้อมูลจำนวนรถน้ำหนักเกิน (%) แบ่งตามประเภทรถ
      <va-button size="small" class="btn-position" @click="dashboardStore.changeExcessWeightDashboardToTotalView()">
        {{ t('dashboard.switchToTotalView') }}
      </va-button>
    </va-card-title>
    <va-card-content>
...
<script setup lang="ts">
  ...
  const horizontalBarChartDataGenerated = useChartData(dashboardStore.totalExcessWeightPercentDashboard)
</script>
