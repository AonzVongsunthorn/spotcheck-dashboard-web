<template>
  <va-card>
    <va-card-title>
      ข้อมูลจำนวนรถน้ำหนักเกิน (คัน) แบ่งตามประเภทรถ
      <va-button size="small" class="btn-position" @click="dashboardStore.changeExcessWeightDashboardToPercentView()">
        {{ t('dashboard.switchToPercentView') }}
      </va-button>
    </va-card-title>
    <va-card-content>
...
<script setup lang="ts">
  ...
  const horizontalBarChartDataGenerated = useChartData(dashboardStore.totalExcessWeightDashboard)
</script>
