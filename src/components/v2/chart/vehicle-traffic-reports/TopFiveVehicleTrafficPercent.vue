<template>
  <va-card>
    <va-card-title>
      ข้อมูลจำนวนรถบรรทุก (%) แบ่งตามประเภทรถ
      <va-button size="small" class="btn-position" @click="dashboardStore.changeTotalVehicleDashboardToTotalView()">
...
<script setup lang="ts">
  ...
  const horizontalBarChartDataGenerated = useChartData(dashboardStore.totalTruckPercentDashboard)
</script>
