    ...
    <div class="!border !border-blue-800">
      ...
      <div class="fixed top-0 right-2 mr-20 !mt-5 z-50">
        <div class="flex gap-5">
          <va-icon class="material-icons" color="#fff" size="large" @click="back()">arrow_back_ios</va-icon>
          <va-icon class="material-icons" color="#fff" size="large" @click="print()">print</va-icon>
        </div>
      </div>
      ...
      <div>
        <table class="table-fixed w-full table-modal text-md">
          ...
          <tr class="bg-[#0f134231]">
            ...
            <td>
              <div class="flex">
                <div class="w-1/2 font-bold">ESAL(f/R10/R11)</div>
                <div class="w-1/2">{{ (traffic.esal || 0).toFixed(5) }}</div>
              </div>
            </td>
          </tr>
          <tr class="bg-[#0f134204]">
            ...
            <td>
              <div class="flex">
                <div class="w-1/2 font-standard font-bold">ผลการคัดกรอง</div>
                <div class="w-1/2">
                  <button v-if="traffic.errorFlags" class="px-3 py-1 bg-red-500 rounded-full text-white font-bold">
                    Error
                  </button>
                  <button
                    v-if="traffic.warningFlags && !traffic.errorFlags"
                    class="px-3 py-1 bg-yellow-500 rounded-full text-black font-bold"
                  >
                    เปลี่ยนช่องจราจร
                  </button>
                  <p v-if="!traffic.warningFlags && !traffic.errorFlags">-</p>
                </div>
              </div>
            </td>
          </tr>
          <tr class="bg-[#0f134231]">
            ...
            <td>
              <div class="flex">
                <div class="w-1/2 font-standard font-bold">นน.เกิน</div>
                <div class="w-1/2">
                  <button
